(ns ^{:mranderson/inlined true} cider.nrepl.inlined.deps.suitable.v0v4v1.suitable.complete-for-nrepl
  (:require [clojure.edn :as edn]
            [cider.nrepl.inlined.deps.suitable.v0v4v1.suitable.js-completions :refer [cljs-completions]]
...
;; of course breaks when cider.nrepl.inlined.deps.suitable.v0v4v1.suitable.complete-for-nrepl is renamed(!).
(def dummy-var)
(def this-ns (:ns (meta #'dummy-var)))

(defn munged-js-introspection-ns []
  (cider.nrepl.inlined.deps.suitable.v0v4v1.suitable.js-completions/js-introspection-ns))
