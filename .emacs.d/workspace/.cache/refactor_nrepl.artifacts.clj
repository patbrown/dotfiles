(ns refactor-nrepl.artifacts
  (:require
   [refactor-nrepl.inlined-deps.datajson.v2v3v1.clojure.data.json :as json]
   [clojure.edn :as edn]
   [clojure.java.io :as io]
   [clojure.string :as str]
   [refactor-nrepl.inlined-deps.http-kit.v2v5v3.org.httpkit.client :as http]
   [refactor-nrepl.inlined-deps.version-clj.v1v0v0.version-clj.core :as versions])
  (:import
