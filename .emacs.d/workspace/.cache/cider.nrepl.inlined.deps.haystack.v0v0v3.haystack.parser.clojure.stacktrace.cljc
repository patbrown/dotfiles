(ns ^{:mranderson/inlined true} cider.nrepl.inlined.deps.haystack.v0v0v3.haystack.parser.clojure.stacktrace
  "Parser for stacktraces in the `clojure.stacktrace` format."
  {:added "0.1.0"
   :author "r0man"}
  (:require [clojure.edn :as edn]
            [cider.nrepl.inlined.deps.haystack.v0v0v3.haystack.parser.util :as util]
            [cider.nrepl.inlined.deps.instaparse.v1v4v12.instaparse.core #?(:clj :refer :cljs :refer-macros) [defparser]]))
