(ns ^{:mranderson/inlined true} cider.nrepl.inlined.deps.cljfmt.v0v9v0.cljfmt.main
  "Functionality to apply formatting to a given project."
  (:require [cider.nrepl.inlined.deps.cljfmt.v0v9v0.cljfmt.core :as cljfmt]
            [clojure.string :as str]
            [clojure.edn :as edn]
            [clojure.java.io :as io]
            [clojure.stacktrace :as st]
            [cider.nrepl.inlined.deps.toolscli.v1v0v206.clojure.tools.cli :as cli]
            [cider.nrepl.inlined.deps.cljfmt.v0v9v0.cljfmt.diff :as diff])
  (:gen-class))
