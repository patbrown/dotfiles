(ns ^{:mranderson/inlined true} refactor-nrepl.inlined-deps.orchard.v0v9v1.orchard.clojuredocs
  ...
  (:require
   ...
   [refactor-nrepl.inlined-deps.orchard.v0v9v1.orchard.util.os :as os])
  (:import
   (java.io IOException)
   (java.net URL)
