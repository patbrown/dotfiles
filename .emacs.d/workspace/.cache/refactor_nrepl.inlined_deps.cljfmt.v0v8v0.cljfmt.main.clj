(ns ^{:mranderson/inlined true} refactor-nrepl.inlined-deps.cljfmt.v0v8v0.cljfmt.main
  "Functionality to apply formatting to a given project."
  (:require [refactor-nrepl.inlined-deps.cljfmt.v0v8v0.cljfmt.core :as cljfmt]
            [clojure.string :as str]
            [clojure.edn :as edn]
            [clojure.java.io :as io]
            [clojure.stacktrace :as st]
            [refactor-nrepl.inlined-deps.toolscli.v1v0v206.clojure.tools.cli :as cli]
            [refactor-nrepl.inlined-deps.cljfmt.v0v8v0.cljfmt.diff :as diff])
  (:gen-class))
